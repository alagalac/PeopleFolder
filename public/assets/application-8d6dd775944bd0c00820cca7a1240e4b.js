...
(function() {
  jQuery(function() {
    return $("#new_comment").bind("ajax:success", function(evt, data, status, xhr) {
      var comment;
      comment = $("<li>", {
  ...
  jQuery(function() {
    return $(".delete_comment").bind("ajax:success", function(evt, data, status, xhr) {
...
(function() {
  jQuery(function() {
    return $(".vote-button").bind("ajax:success", function(evt, data, status, xhr) {
      $(this).toggleClass("btn-success");
      $(this).toggleClass("btn-default");
      return $(this).html('<span class="glyphicon glyphicon-star"></span> ' + data);
    });
  });
...
(function() {
  jQuery(function() {
    var btnbr, content, hiddenDiv, txt;
    txt = $("#wmd-input");
    ...
    txt.on("keyup", function() {
      ...
      return $(this).css("height", hiddenDiv.height() + 15);
    });
    ...
    btnbr.on("click", function() {
      ...
      content = content.replace(/\n/g, "<br>");
      hiddenDiv.html(content + "<br class=\"lbr\">");
      return $("#wmd-input").css("height", hiddenDiv.height() + 15);
    });
    return txt.trigger("keyup");
  });

  jQuery(function() {
    var converter;
    converter = new Markdown.Converter();
    return $(".markdown_content").each(function() {
      return $(this).html(converter.makeHtml($(this).text()));
    });
  });
